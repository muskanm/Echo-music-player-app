...
import com.example.admin2.echo.CurrentSongHelper
...
import com.example.admin2.echo.databases.EchoDatabase
...
class SongPlayingFragment : Fragment() {
    ...
    object Staticated {
        ...
        fun processInformation(mediaPlayer: MediaPlayer) {
            ...
            Statified.startTimeText?.setText(String.format("%d: %d",
                    ...
                    TimeUnit.MILLISECONDS.toSeconds(startTime.toLong()) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(startTime.toLong() as Long))))
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        Statified.myActivity?.getSharedPreferences(Staticated.MY_PREFS_LOOP, Context.MODE_PRIVATE)
